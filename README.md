...
**ReadyPython** est une bibliothèque de fonctions Python pour le développement d'applications en Python.  
...
Les Concepts Abordés sur la **Distribution d'Appliction Python** :  
* [CxFreeze](https://github.com/gkesse/ReadyPython/tree/master/CxFreeze "CxFreeze")  
* [CxFreeze Setup](https://github.com/gkesse/ReadyPython/tree/master/CxFreeze_Setup "CxFreeze Setup")  
...
Le développement de la bibliothèque **ReadyPython** a nécessité les technologies suivantes :

* Langage : **Python**
* Editeur de Texte : **Notepad++**
* Outil de Déploiement : **CxFreeze**
* Cible : **Windows, UNIX**
